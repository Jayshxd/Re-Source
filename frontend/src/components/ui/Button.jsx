...
const Button = ({ 
  ...
  const variants = {
    ...
    secondary: 'bg-dark-800 text-slate-100 hover:bg-dark-700 focus:ring-dark-600 border border-dark-700',
    danger: 'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500',
    ghost: 'text-slate-300 hover:bg-dark-800 focus:ring-dark-600',
  };
